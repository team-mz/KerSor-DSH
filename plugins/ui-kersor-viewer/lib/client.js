window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const css$1 = "._7E3fq_view{box-sizing:border-box;background:var(--dsw-alias-bg-layer-1);width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-tertiary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);flex-direction:column;display:flex;overflow:hidden}._7E3fq_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;gap:8px;min-height:44px;padding:10px 12px;display:flex}._7E3fq_title{color:var(--dsw-alias-label-primary);flex:none;font-size:13px;font-weight:500;line-height:20px}._7E3fq_note,._7E3fq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}._7E3fq_note{text-align:right;text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7E3fq_readError{color:var(--dsw-alias-state-error-primary)}._7E3fq_body{min-height:0;padding:4px 12px;padding-bottom:calc(var(--dsh-composer-height,152px) + 24px);flex:1;overflow-y:auto}._7E3fq_launcher{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);border-radius:12px;flex-direction:column;gap:8px;margin:4px 0 10px;padding:10px 12px;display:flex}._7E3fq_launcherHead,._7E3fq_taskRow,._7E3fq_activeRow{align-items:center;gap:8px;display:flex}._7E3fq_launcherHead{justify-content:space-between}._7E3fq_launcherTitle,._7E3fq_taskLabel{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:510;line-height:18px}._7E3fq_launcherSummary,._7E3fq_activeRunId{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._7E3fq_taskList,._7E3fq_activeList{flex-direction:column;gap:4px;display:flex}._7E3fq_taskRow,._7E3fq_activeRow{min-height:28px}._7E3fq_taskLabel,._7E3fq_activeLabel{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._7E3fq_activeLabel{color:var(--dsw-alias-label-secondary);flex-direction:column;font-size:12px;line-height:16px;display:flex}._7E3fq_activeRunId{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7E3fq_controlButton{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);min-width:52px;height:26px;color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:7px;flex:none;padding:0 10px;font-family:inherit;font-size:11px}._7E3fq_controlButton:hover:not(:disabled){background:var(--dsw-alias-bg-hover-secondary)}._7E3fq_controlButton:disabled{cursor:default;opacity:.55}._7E3fq_controlButton[data-busy=true]{color:var(--dsw-alias-state-business-primary)}._7E3fq_activitySection{flex-direction:column;gap:6px;margin-top:8px;display:flex}._7E3fq_sectionHead,._7E3fq_classicHead,._7E3fq_classicFoot{align-items:center;gap:8px;display:flex}._7E3fq_sectionHead{justify-content:space-between;min-height:24px;padding:0 2px}._7E3fq_sectionTitle{color:var(--dsw-alias-label-primary);font-size:12px;font-weight:510;line-height:18px}._7E3fq_sectionSummary{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._7E3fq_classicRows{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin:0;padding:0;list-style:none;display:grid}._7E3fq_classicRow{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:6px;min-width:0;padding:10px;display:flex}._7E3fq_classicRow[data-session-health=active]{border-color:var(--dsw-alias-state-business-primary)}._7E3fq_classicRow[data-session-health=stale],._7E3fq_classicRow[data-session-health=needs_resume],._7E3fq_classicRow[data-session-health=unknown]{border-color:var(--dsw-alias-state-warn-secondary)}._7E3fq_classicRow[data-expanded=true]{grid-column:1/-1}._7E3fq_classicHead{min-width:0}._7E3fq_classicExpand{width:20px;height:20px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:5px;flex:none;justify-content:center;align-items:center;padding:0;transition:transform .12s,background .12s;display:inline-flex}._7E3fq_classicExpand:hover{background:var(--dsw-alias-bg-base)}._7E3fq_classicExpand[aria-expanded=true]{transform:rotate(90deg)}._7E3fq_sessionId{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:11px;font-weight:510;line-height:16px;overflow:hidden}._7E3fq_phaseBadge{background:var(--dsw-alias-bg-base);max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;border-radius:5px;flex:none;padding:1px 5px;font-size:10px;line-height:15px;overflow:hidden}._7E3fq_workspaceBadge,._7E3fq_selectedBadge{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-state-warn-label);white-space:nowrap;border-radius:5px;flex:none;padding:1px 5px;font-size:10px;line-height:15px}._7E3fq_selectedBadge{color:var(--dsw-alias-state-business-primary)}._7E3fq_classicMetrics{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:2px 8px;font-size:10px;line-height:15px;display:flex}._7E3fq_classicMetrics [data-target-met=true]{color:var(--dsw-alias-state-success-primary)}._7E3fq_routeBadge,._7E3fq_authoringBadge,._7E3fq_gateBadge{background:var(--dsw-alias-bg-base);border-radius:5px;padding:0 5px}._7E3fq_routeBadge{color:var(--dsw-alias-label-secondary);font-family:ui-monospace,SFMono-Regular,Menlo,monospace}._7E3fq_authoringBadge{color:var(--dsw-alias-state-business-primary)}._7E3fq_gateBadge[data-gate=pass]{color:var(--dsw-alias-state-success-primary)}._7E3fq_gateBadge[data-gate=fail]{color:var(--dsw-alias-state-error-primary)}._7E3fq_gateBadge[data-gate=pending]{color:var(--dsw-alias-state-warn-label)}._7E3fq_baselineAction{border-left:2px solid var(--dsw-alias-state-warn-label);background:var(--dsw-alias-bg-base);border-radius:5px;flex-direction:column;gap:1px;padding:4px 7px;font-size:10px;line-height:15px;display:flex}._7E3fq_baselineAction[data-baseline-action=new_session]{border-left-color:var(--dsw-alias-state-error-primary)}._7E3fq_baselineActionLabel{color:var(--dsw-alias-label-secondary);font-weight:510}._7E3fq_baselineAction[data-baseline-action=new_session] ._7E3fq_baselineActionLabel{color:var(--dsw-alias-state-error-primary)}._7E3fq_baselineActionReason{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;-webkit-line-clamp:2;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._7E3fq_profileBlock{border-left:2px solid var(--dsw-alias-state-error-primary);background:var(--dsw-alias-bg-base);border-radius:5px;flex-direction:column;gap:1px;padding:4px 7px;font-size:10px;line-height:15px;display:flex}._7E3fq_profileBlockLabel{color:var(--dsw-alias-state-error-primary);font-weight:510}._7E3fq_profileBlockReason{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;-webkit-line-clamp:2;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}._7E3fq_classicFoot{min-width:0;color:var(--dsw-alias-label-secondary);justify-content:space-between;font-size:10px;line-height:15px}._7E3fq_workflowName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}._7E3fq_fitBadge{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);border-radius:5px;flex:none;padding:0 5px}._7E3fq_fitBadge[data-fit-confidence=high]{color:var(--dsw-alias-state-success-primary)}._7E3fq_fitBadge[data-fit-confidence=low]{color:var(--dsw-alias-state-warn-label)}._7E3fq_warningCount{color:var(--dsw-alias-state-warn-label);cursor:help;flex:none}._7E3fq_decisionReason{border-top:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;-webkit-line-clamp:2;-webkit-box-orient:vertical;padding-top:5px;font-size:10px;line-height:15px;display:-webkit-box;overflow:hidden}._7E3fq_classicDetail{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:10px;padding-top:8px;display:flex}._7E3fq_outcomeSummary,._7E3fq_roundHistory{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:9px;flex-direction:column;gap:7px;padding:10px;display:flex}._7E3fq_outcomeSummary[data-stop-reason=target_met]{border-color:var(--dsw-alias-state-success-primary)}._7E3fq_outcomeSummary[data-stop-reason=execution_budget_exhausted],._7E3fq_outcomeSummary[data-stop-reason=selection_stalled],._7E3fq_outcomeSummary[data-stop-reason=authoring_budget_exhausted]{border-color:var(--dsw-alias-state-warn-secondary)}._7E3fq_outcomeHead,._7E3fq_outcomeMetrics,._7E3fq_roundHead,._7E3fq_roundFacts,._7E3fq_stopNode{align-items:center;gap:6px 10px;display:flex}._7E3fq_outcomeHead{color:var(--dsw-alias-label-secondary);justify-content:space-between;font-size:11px;line-height:16px}._7E3fq_outcomeMetrics,._7E3fq_roundFacts{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;font-size:11px;line-height:16px}._7E3fq_outcomeMetrics>strong{color:var(--dsw-alias-label-primary)}._7E3fq_roundTree{flex-direction:column;gap:0;margin:0;padding:0;list-style:none;display:flex}._7E3fq_roundNode,._7E3fq_stopNode{border-left:1px solid var(--dsw-alias-border-l1);margin-left:5px;padding:8px 8px 8px 20px;position:relative}._7E3fq_roundNode:before,._7E3fq_stopNode:before{border-top:1px solid var(--dsw-alias-border-l1);content:\"\";width:12px;position:absolute;top:16px;left:0}._7E3fq_roundNode[data-host-verdict=fail]{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 4%, transparent)}._7E3fq_roundHead{min-width:0;color:var(--dsw-alias-label-secondary);font-size:11px;line-height:17px}._7E3fq_roundHead>strong{color:var(--dsw-alias-label-primary);flex:none}._7E3fq_roundWorkflow{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;overflow:hidden}._7E3fq_roundVerdict,._7E3fq_authoredBadge,._7E3fq_promotedBadge,._7E3fq_failureBadge,._7E3fq_excludedBadge{background:var(--dsw-alias-bg-module-platform);white-space:nowrap;border-radius:5px;flex:none;padding:1px 5px}._7E3fq_roundNode[data-host-verdict=pass] ._7E3fq_roundVerdict,._7E3fq_promotedBadge,._7E3fq_roundFacts [data-measurement=measured]{color:var(--dsw-alias-state-success-primary)}._7E3fq_roundNode[data-host-verdict=fail] ._7E3fq_roundVerdict,._7E3fq_failureBadge{color:var(--dsw-alias-state-error-primary)}._7E3fq_authoredBadge{color:var(--dsw-alias-state-business-primary)}._7E3fq_excludedBadge,._7E3fq_roundFacts [data-measurement=estimated]{color:var(--dsw-alias-state-warn-label)}._7E3fq_authoringChain,._7E3fq_roundDecision{color:var(--dsw-alias-label-tertiary);overflow-wrap:anywhere;margin:5px 0 0 20px;font-size:10px;line-height:15px}._7E3fq_authoringChain{border-left:2px solid var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary);padding-left:7px}._7E3fq_stopNode{color:var(--dsw-alias-label-secondary);font-size:11px;line-height:17px}._7E3fq_timeline{grid-template-columns:repeat(3,minmax(0,1fr));gap:4px 8px;margin:0;padding:0;list-style:none;display:grid}._7E3fq_timelineStep{min-width:0;color:var(--dsw-alias-label-tertiary);align-items:center;gap:5px;font-size:10px;line-height:15px;display:flex}._7E3fq_timelineStep[data-step-status=active]{color:var(--dsw-alias-state-business-primary)}._7E3fq_timelineStep[data-step-status=failed]{color:var(--dsw-alias-state-error-primary)}._7E3fq_detailGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;display:grid}._7E3fq_detailSection{background:var(--dsw-alias-bg-base);min-width:0;color:var(--dsw-alias-label-tertiary);border-radius:8px;flex-direction:column;gap:3px;padding:8px;font-size:10px;line-height:15px;display:flex}._7E3fq_detailTitle{color:var(--dsw-alias-label-primary);font-weight:510}._7E3fq_detailReason,._7E3fq_detailPath{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7E3fq_detailPath{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}._7E3fq_detailNote,._7E3fq_detailError{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}._7E3fq_detailError{color:var(--dsw-alias-state-error-primary)}._7E3fq_mono{font-family:ui-monospace,SFMono-Regular,Menlo,monospace}._7E3fq_checks{flex-wrap:wrap;gap:2px 8px;margin:0;padding:0;list-style:none;display:flex}._7E3fq_checks [data-check-passed=true]{color:var(--dsw-alias-state-success-primary)}._7E3fq_checks [data-check-passed=false]{color:var(--dsw-alias-state-error-primary)}._7E3fq_artifacts{color:var(--dsw-alias-label-tertiary);flex-direction:column;gap:2px;font-size:10px;line-height:15px;display:flex}._7E3fq_design{flex-direction:column;gap:6px;display:flex}._7E3fq_designText{color:var(--dsw-alias-label-secondary);margin:0;font-size:10px;line-height:16px}._7E3fq_workflowTree{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;padding:8px}._7E3fq_workflowRoot,._7E3fq_workflowPhase{min-width:0;color:var(--dsw-alias-label-primary);align-items:flex-start;gap:6px;font-size:10px;line-height:15px;display:flex}._7E3fq_workflowRoot{align-items:center;font-weight:510}._7E3fq_workflowBranches{flex-direction:column;gap:5px;padding-top:5px;padding-left:12px;display:flex}._7E3fq_workflowBranch{width:10px;color:var(--dsw-alias-label-quaternary);font-family:ui-monospace,SFMono-Regular,Menlo,monospace}._7E3fq_workflowPhaseIndex{background:var(--dsw-alias-bg-layer-1);width:16px;height:16px;color:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;justify-content:center;align-items:center;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;display:inline-flex}._7E3fq_workflowPhaseBody{min-width:0;color:var(--dsw-alias-label-tertiary);flex-direction:column;gap:1px;display:flex}._7E3fq_workflowPhaseBody strong{color:var(--dsw-alias-label-primary);font-weight:510}._7E3fq_designMeta{flex-wrap:wrap;gap:4px;display:flex}._7E3fq_designMeta>span{background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);border-radius:5px;padding:1px 5px;font-size:10px;line-height:15px}._7E3fq_requiredArgs{color:var(--dsw-alias-label-tertiary);font-size:10px;line-height:15px}._7E3fq_designDisclosure{background:var(--dsw-alias-bg-base);border-radius:8px}._7E3fq_designDisclosure>summary{color:var(--dsw-alias-label-secondary);cursor:pointer;padding:7px 8px;font-size:10px;line-height:15px}._7E3fq_designDisclosure>pre{border-top:1px solid var(--dsw-alias-border-l2);max-height:320px;color:var(--dsw-alias-label-secondary);white-space:pre-wrap;word-break:break-word;margin:0;padding:8px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:9px;line-height:14px;overflow:auto}@media (width<=520px){._7E3fq_classicRows,._7E3fq_timeline,._7E3fq_detailGrid{grid-template-columns:1fr}}._7E3fq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}._7E3fq_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:6px;padding:10px 12px;display:flex}._7E3fq_row[data-run-status=active]{border-color:var(--dsw-alias-state-business-primary)}._7E3fq_rowHead{width:100%;color:inherit;text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:8px;padding:2px;font-family:inherit;display:flex}._7E3fq_rowHead:hover{background:var(--dsw-alias-bg-hover-secondary)}._7E3fq_rowHead[aria-pressed=true]{background:var(--dsw-alias-bg-active-secondary)}._7E3fq_runId{max-width:20%;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:10px;line-height:16px;overflow:hidden}._7E3fq_rowLabel{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;font-weight:510;line-height:18px;overflow:hidden}._7E3fq_runDetail{border-top:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;padding:4px 2px 2px;display:flex}._7E3fq_runHead{justify-content:space-between;align-items:center;gap:8px;display:flex}._7E3fq_workflowIdentity{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:510;line-height:20px;overflow:hidden}._7E3fq_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}._7E3fq_runMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:4px 12px;font-size:11px;line-height:16px;display:flex}._7E3fq_runError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}._7E3fq_executionTree,._7E3fq_treeGroup{margin:0;padding:0;list-style:none}._7E3fq_executionTree{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);border-radius:10px;margin-top:6px;padding:9px}._7E3fq_treeGroup{border-left:1px solid var(--dsw-alias-border-l1);margin-left:6px;padding-left:20px}._7E3fq_treeGroup>li{margin-top:3px;position:relative}._7E3fq_treeGroup>li:before{background:var(--dsw-alias-border-l1);content:\"\";width:15px;height:1px;position:absolute;top:15px;left:-20px}._7E3fq_treeNode,._7E3fq_treeNodeButton,._7E3fq_hostStep{min-width:0;min-height:30px;color:var(--dsw-alias-label-secondary);align-items:center;gap:7px;font-size:11px;line-height:16px;display:flex}._7E3fq_treeNode>span:nth-child(2),._7E3fq_treeNodeButton>._7E3fq_callLabel{color:var(--dsw-alias-label-primary);font-weight:510}._7E3fq_treeNode>span:last-child{color:var(--dsw-alias-label-tertiary);margin-left:auto}._7E3fq_treeNodeButton{text-align:left;cursor:pointer;background:0 0;border:0;border-radius:6px;width:100%;padding:2px 4px;font-family:inherit}._7E3fq_treeNodeButton:hover{background:var(--dsw-alias-bg-hover-secondary)}._7E3fq_treeNodeButton>svg:last-child{flex:none;transition:transform .12s}._7E3fq_callTreeItem[aria-expanded=true]>._7E3fq_treeNodeButton>svg:last-child{transform:rotate(90deg)}._7E3fq_phaseTreeItem[data-parallel=true]>._7E3fq_treeNode{background:var(--dsw-alias-bg-base);border-radius:6px}._7E3fq_phaseTreeItem[data-phase-status=failed]>._7E3fq_treeNode,._7E3fq_callTreeItem[data-call-status=failed]>._7E3fq_treeNodeButton,._7E3fq_hostTreeItem[data-step-status=failed]>._7E3fq_treeNode{color:var(--dsw-alias-state-error-primary)}._7E3fq_hostTreeItem>._7E3fq_treeNode{border-top:1px solid var(--dsw-alias-border-l2);margin-top:6px;padding-top:5px}._7E3fq_hostStep>span:last-child{color:var(--dsw-alias-label-tertiary);margin-left:auto}._7E3fq_callDetail{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;flex-direction:column;gap:7px;margin:3px 0 7px;padding:8px;display:flex}._7E3fq_callDetailMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;gap:4px 10px;font-size:10px;line-height:15px;display:flex}._7E3fq_callMessages{flex-direction:column;gap:5px;display:flex}._7E3fq_callMessages>pre{background:var(--dsw-alias-bg-module-platform);max-height:260px;color:var(--dsw-alias-label-secondary);white-space:pre-wrap;word-break:break-word;border-radius:6px;margin:0;padding:7px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:10px;line-height:15px;overflow:auto}._7E3fq_callActivities{flex-direction:column;gap:3px;margin:0;padding:0;list-style:none;display:flex}._7E3fq_callActivities>li{color:var(--dsw-alias-label-tertiary);grid-template-columns:auto minmax(0,1fr) auto;gap:7px;font-size:10px;line-height:15px;display:grid}._7E3fq_callActivities ._7E3fq_mono{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}._7E3fq_workflowResult{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);border-radius:10px;flex-direction:column;gap:8px;margin-top:4px;padding:10px;display:flex}._7E3fq_resultHead,._7E3fq_resultMetrics{flex-wrap:wrap;align-items:center;gap:6px 12px;display:flex}._7E3fq_resultHead{justify-content:space-between}._7E3fq_resultStage,._7E3fq_resultMetrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}._7E3fq_resultMetrics [data-measurement=measured]{color:var(--dsw-alias-state-success-primary)}._7E3fq_resultMetrics [data-measurement=estimated]{color:var(--dsw-alias-state-warn-label)}._7E3fq_resultMetrics [data-verification=passed]{color:var(--dsw-alias-state-success-primary)}._7E3fq_resultMetrics [data-verification=failed]{color:var(--dsw-alias-state-error-primary)}._7E3fq_candidates{grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:6px;margin:0;padding:0;list-style:none;display:grid}._7E3fq_candidate{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;color:var(--dsw-alias-label-tertiary);border-radius:7px;flex-direction:column;gap:2px;padding:7px;font-size:10px;line-height:15px;display:flex}._7E3fq_candidate[data-selected=true]{border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}._7E3fq_phaseSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:11px;line-height:16px;overflow:hidden}._7E3fq_callLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}._7E3fq_callMeta{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:6px;font-size:11px;line-height:16px;display:inline-flex}._7E3fq_badge{border:1px solid var(--dsw-alias-border-l2);border-radius:4px;padding:0 4px}._7E3fq_callStatus{color:var(--dsw-alias-label-tertiary);flex:none;font-size:11px;font-weight:510;line-height:16px}._7E3fq_callTreeItem[data-call-status=failed] ._7E3fq_callStatus{color:var(--dsw-alias-state-error-primary)}";
		...
		var _dsh_css_64557083eb0f58b9_default = {
			"activeLabel": "_7E3fq_activeLabel",
			"activeList": "_7E3fq_activeList",
			"activeRow": "_7E3fq_activeRow",
			"activeRunId": "_7E3fq_activeRunId",
			"activitySection": "_7E3fq_activitySection",
			"artifacts": "_7E3fq_artifacts",
			"authoredBadge": "_7E3fq_authoredBadge",
			"authoringBadge": "_7E3fq_authoringBadge",
			"authoringChain": "_7E3fq_authoringChain",
			"badge": "_7E3fq_badge",
			"baselineAction": "_7E3fq_baselineAction",
			"baselineActionLabel": "_7E3fq_baselineActionLabel",
			"baselineActionReason": "_7E3fq_baselineActionReason",
			"body": "_7E3fq_body",
			"callActivities": "_7E3fq_callActivities",
			"callDetail": "_7E3fq_callDetail",
			"callDetailMeta": "_7E3fq_callDetailMeta",
			"callLabel": "_7E3fq_callLabel",
			"callMessages": "_7E3fq_callMessages",
			"callMeta": "_7E3fq_callMeta",
			"callStatus": "_7E3fq_callStatus",
			"callTreeItem": "_7E3fq_callTreeItem",
			"candidate": "_7E3fq_candidate",
			"candidates": "_7E3fq_candidates",
			"checks": "_7E3fq_checks",
			"classicDetail": "_7E3fq_classicDetail",
			"classicExpand": "_7E3fq_classicExpand",
			"classicFoot": "_7E3fq_classicFoot",
			"classicHead": "_7E3fq_classicHead",
			"classicMetrics": "_7E3fq_classicMetrics",
			"classicRow": "_7E3fq_classicRow",
			"classicRows": "_7E3fq_classicRows",
			"controlButton": "_7E3fq_controlButton",
			"decisionReason": "_7E3fq_decisionReason",
			"design": "_7E3fq_design",
			"designDisclosure": "_7E3fq_designDisclosure",
			"designMeta": "_7E3fq_designMeta",
			"designText": "_7E3fq_designText",
			"detailError": "_7E3fq_detailError",
			"detailGrid": "_7E3fq_detailGrid",
			"detailNote": "_7E3fq_detailNote",
			"detailPath": "_7E3fq_detailPath",
			"detailReason": "_7E3fq_detailReason",
			"detailSection": "_7E3fq_detailSection",
			"detailTitle": "_7E3fq_detailTitle",
			"excludedBadge": "_7E3fq_excludedBadge",
			"executionTree": "_7E3fq_executionTree",
			"failureBadge": "_7E3fq_failureBadge",
			"fitBadge": "_7E3fq_fitBadge",
			"gateBadge": "_7E3fq_gateBadge",
			"header": "_7E3fq_header",
			"hostStep": "_7E3fq_hostStep",
			"hostTreeItem": "_7E3fq_hostTreeItem",
			"launcher": "_7E3fq_launcher",
			"launcherHead": "_7E3fq_launcherHead",
			"launcherSummary": "_7E3fq_launcherSummary",
			"launcherTitle": "_7E3fq_launcherTitle",
			"mono": "_7E3fq_mono",
			"note": "_7E3fq_note",
			"outcomeHead": "_7E3fq_outcomeHead",
			"outcomeMetrics": "_7E3fq_outcomeMetrics",
			"outcomeSummary": "_7E3fq_outcomeSummary",
			"phaseBadge": "_7E3fq_phaseBadge",
			"phaseSummary": "_7E3fq_phaseSummary",
			"phaseTreeItem": "_7E3fq_phaseTreeItem",
			"profileBlock": "_7E3fq_profileBlock",
			"profileBlockLabel": "_7E3fq_profileBlockLabel",
			"profileBlockReason": "_7E3fq_profileBlockReason",
			"promotedBadge": "_7E3fq_promotedBadge",
			"readError": "_7E3fq_readError",
			"requiredArgs": "_7E3fq_requiredArgs",
			"resultHead": "_7E3fq_resultHead",
			"resultMetrics": "_7E3fq_resultMetrics",
			"resultStage": "_7E3fq_resultStage",
			"roundDecision": "_7E3fq_roundDecision",
			"roundFacts": "_7E3fq_roundFacts",
			"roundHead": "_7E3fq_roundHead",
			"roundHistory": "_7E3fq_roundHistory",
			"roundNode": "_7E3fq_roundNode",
			"roundTree": "_7E3fq_roundTree",
			"roundVerdict": "_7E3fq_roundVerdict",
			"roundWorkflow": "_7E3fq_roundWorkflow",
			"routeBadge": "_7E3fq_routeBadge",
			"row": "_7E3fq_row",
			"rowHead": "_7E3fq_rowHead",
			"rowLabel": "_7E3fq_rowLabel",
			"rows": "_7E3fq_rows",
			"runDetail": "_7E3fq_runDetail",
			"runError": "_7E3fq_runError",
			"runHead": "_7E3fq_runHead",
			"runId": "_7E3fq_runId",
			"runMeta": "_7E3fq_runMeta",
			"sectionHead": "_7E3fq_sectionHead",
			"sectionSummary": "_7E3fq_sectionSummary",
			"sectionTitle": "_7E3fq_sectionTitle",
			"selectedBadge": "_7E3fq_selectedBadge",
			"sessionId": "_7E3fq_sessionId",
			"statusTail": "_7E3fq_statusTail",
			"stopNode": "_7E3fq_stopNode",
			"taskLabel": "_7E3fq_taskLabel",
			"taskList": "_7E3fq_taskList",
			"taskRow": "_7E3fq_taskRow",
			"timeline": "_7E3fq_timeline",
			"timelineStep": "_7E3fq_timelineStep",
			"title": "_7E3fq_title",
			"treeGroup": "_7E3fq_treeGroup",
			"treeNode": "_7E3fq_treeNode",
			"treeNodeButton": "_7E3fq_treeNodeButton",
			"view": "_7E3fq_view",
			"warningCount": "_7E3fq_warningCount",
			"workflowBranch": "_7E3fq_workflowBranch",
			"workflowBranches": "_7E3fq_workflowBranches",
			"workflowIdentity": "_7E3fq_workflowIdentity",
			"workflowName": "_7E3fq_workflowName",
			"workflowPhase": "_7E3fq_workflowPhase",
			"workflowPhaseBody": "_7E3fq_workflowPhaseBody",
			"workflowPhaseIndex": "_7E3fq_workflowPhaseIndex",
			"workflowResult": "_7E3fq_workflowResult",
			"workflowRoot": "_7E3fq_workflowRoot",
			"workflowTree": "_7E3fq_workflowTree",
			"workspaceBadge": "_7E3fq_workspaceBadge"
		};
		//#endregion
		...
		const css = ".cpipTa_card{border:1px solid var(--dsw-alias-border-normal,#d9dce3);background:var(--dsw-alias-bg-module-platform,#fff);border-radius:12px;margin:8px 0 14px;padding:14px}.cpipTa_header,.cpipTa_footer,.cpipTa_facts{align-items:center;display:flex}.cpipTa_header{justify-content:space-between;gap:12px}.cpipTa_eyebrow{color:var(--dsw-alias-fg-secondary,#667085);font-size:12px}.cpipTa_title{margin-top:2px;font-weight:650}.cpipTa_status{background:var(--dsw-alias-bg-base-hover,#f2f4f7);border-radius:999px;padding:3px 8px;font-size:12px}.cpipTa_objective,.cpipTa_next{margin:10px 0 0;line-height:1.45}.cpipTa_facts{color:var(--dsw-alias-fg-secondary,#667085);flex-wrap:wrap;gap:6px 12px;margin-top:10px;font-size:12px}.cpipTa_progress{margin-top:12px}.cpipTa_progressTrack{background:var(--dsw-alias-bg-base-hover,#eaecf0);border-radius:999px;height:4px;overflow:hidden}.cpipTa_progressTrack>span{border-radius:inherit;background:var(--dsw-alias-fg-business-primary,#4f46e5);height:100%;transition:width .16s;display:block}.cpipTa_steps{grid-template-columns:repeat(auto-fit,minmax(92px,1fr));gap:8px;margin:10px 0 0;padding:0;font-size:12px;list-style:none;display:grid}.cpipTa_steps li{align-items:center;gap:6px;min-width:0;display:flex}.cpipTa_dot{background:#98a2b3;border-radius:50%;flex:none;width:8px;height:8px}.cpipTa_steps li[data-step-status=active] .cpipTa_dot{background:#f79009}.cpipTa_steps li[data-step-status=completed] .cpipTa_dot{background:#12b76a}.cpipTa_steps li[data-step-status=failed] .cpipTa_dot{background:#f04438}.cpipTa_next{background:var(--dsw-alias-bg-base-hover,#f7f8fa);border-radius:8px;padding:8px 10px;font-size:13px}.cpipTa_footer{justify-content:space-between;gap:12px;margin-top:12px}.cpipTa_open{border:1px solid var(--dsw-alias-border-normal,#d0d5dd);color:inherit;cursor:pointer;background:0 0;border-radius:8px;padding:6px 10px}.cpipTa_open:disabled{cursor:default;opacity:.5}.cpipTa_footer code{color:var(--dsw-alias-fg-secondary,#667085);text-overflow:ellipsis;white-space:nowrap;font-size:10px;overflow:hidden}";
		...
		var _dsh_css_5e80a47b73f6677b_default = {
			"card": "cpipTa_card",
			"dot": "cpipTa_dot",
			"eyebrow": "cpipTa_eyebrow",
			"facts": "cpipTa_facts",
			"footer": "cpipTa_footer",
			"header": "cpipTa_header",
			"next": "cpipTa_next",
			"objective": "cpipTa_objective",
			"open": "cpipTa_open",
			"progress": "cpipTa_progress",
			"progressTrack": "cpipTa_progressTrack",
			"status": "cpipTa_status",
			"steps": "cpipTa_steps",
			"title": "cpipTa_title"
		};
		//#endregion
