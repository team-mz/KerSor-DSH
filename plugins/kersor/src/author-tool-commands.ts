 ...
 */
export function canonicalAuthorHandoffSealCommand(
  kersorPython: string,
  sessionDir: string,
): string {
 ...
 */
export function canonicalAuthorSaveCommand(
  kersorPython: string,
  sessionDir: string,
): string {
 ...
 */
export function hostCanonicalAuthorToolArguments(
  value: unknown,
  ...
  return args.command === expectedCommand
    ...
    && (args.timeoutMs === undefined
      || Number.isSafeInteger(args.timeoutMs) && (args.timeoutMs as number) > 0)
}
 ...
 */
export function canonicalAuthorCommandKind(
  value: unknown,
  commands: CanonicalAuthorCommands,
): CanonicalAuthorCommandKind | undefined {
